...
> **历史快照（2026-07-09，不得用于当前发布决策）。** 本报告保留当时问题证据；其中关于微信支付为壳、生产回落 Mock、默认 Seed 与员工登录的描述已被后续实现取代。当前发布必须以 `README.md`、`docs/production-checklist.md`、最新自动化门禁及实际微信/TLS 验收结果为准。
