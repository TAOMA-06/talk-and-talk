...
export const metadata: Metadata = {
  ...
  description:
    "Talk&Talk 官方网站。女性友好的线上陪伴平台：有边界的线上陪伴，从被认真听见开始。官网说明品牌、规则与公示；身份核验通道完成前不开放新预约、支付或聊天。",
  ...
  openGraph: {
    ...
    description: "女性友好的线上陪伴平台。官网说明品牌、规则与公示；服务开放状态以微信小程序为准。",
    type: "website",
    locale: "zh_CN",
  ...
  twitter: {
    ...
    title: "Talk&Talk｜有边界的线上陪伴，从被认真听见开始",
    description: "女性友好的线上陪伴平台官方网站。官网说明品牌、规则与公示；身份核验通道完成前不开放新预约、支付或聊天。",
    images: [socialImage],
  },
  robots: {
    index: true,
