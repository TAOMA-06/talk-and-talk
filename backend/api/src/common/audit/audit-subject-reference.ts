...
> = Object.freeze({
  ...
  "favorite.availability_reminder_enabled": [{ key: "companionId", identifierKind: "companion" }],
  "favorite.availability_reminder_disabled": [{ key: "companionId", identifierKind: "companion" }],
  ...
  "commercial.companion_incident_claimed": [
    { key: "companionId", identifierKind: "companion" },
    { key: "assignedToUserId", identifierKind: "user" }
  ],
  "commercial.companion_incident_assigned": [
    { key: "companionId", identifierKind: "companion" },
    { key: "previousAssignedToUserId", identifierKind: "user" },
    { key: "assignedToUserId", identifierKind: "user" }
  ],
  ...
  "commercial.companion_action_appeal_claimed": [
    { key: "companionId", identifierKind: "companion" },
    { key: "assignedToUserId", identifierKind: "user" },
    { key: "originalActionCreatedById", identifierKind: "user" }
  ],
  ...
  "commercial.companion_action_reactivation_completed": [{ key: "companionId", identifierKind: "companion" }],
  "commercial.companion_suspension_expiry_reactivation_required": [{ key: "companionId", identifierKind: "companion" }],
...
const SYSTEM_WITH_SUBJECT_AUDIT_ACTIONS = [
  ...
  "commercial.companion_suspension_expiry_reactivation_required",
...
const EXPLICIT_BUSINESS_SUBJECT_AUDIT_ACTIONS = [
  ...
  "commercial.companion_action_appeal_claimed",
  "commercial.companion_action_appeal_assigned",
  "commercial.companion_action_reactivation_completed",
