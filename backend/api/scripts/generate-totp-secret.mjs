...
const reviewUsername = process.env.REVIEW_BOOTSTRAP_USERNAME?.trim().toLowerCase();
const username = reviewUsername || process.env.STAFF_BOOTSTRAP_USERNAME?.trim().toLowerCase() || "staff";
const issuer = reviewUsername ? "Talk&Talk 审核部门" : "Talk&Talk";
